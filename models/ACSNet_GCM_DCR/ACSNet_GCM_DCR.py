...
from models.ACSNet_GCM_DCR.modules_GCM_DCR import GCM, ASM, LCA4, LCA1, LCA23, GCM_RFB, ASM_nogcm, GCM23, GCM1, GCM4
from models.ACSNet_GCM_DCR.modules import conv2d, conv1d, PAM_Module
...
class ACSNet_GCM_DCR(nn.Module):
    def __init__(self,
                 bank_size=20,
                 num_classes=1,
                 num_channels=3,
        ...
        super(ACSNet_GCM_DCR, self).__init__()
        ...
        # self.lca4 = LCA4(256)
        self.gcm1 = GCM1(64)
        self.gcm2 = GCM23(64, 128)
        self.gcm3 = GCM23(128, 256)
        self.gcm4 = GCM4(256)
