...
from models.ACSNet_caRAsa_DCR.modules_caRAsa_DCR import GCM, ASM, GCM_RFB, ASM_nogcm, CSAMBlock, \
    LCA11, LCA32, LCA44, RA1, RA23, RA4, NonLocalBlock, CSAMBlock1, CSAMBlock432, GCM_RFB_s, GCM_CBAM23, \
    GCM_CBAM1, GCM_CBAM4, GCM_CBAM, SoftPooling2D
from models.ACSNet_caRAsa_DCR.modules import conv2d, conv1d, PAM_Module, CAM_Module
...
class ACSNet_caRAsa_DCR(nn.Module):
    def __init__(self,
                 bank_size=20,
                 num_classes=1,
                 num_channels=3,
        ...
        super(ACSNet_caRAsa_DCR, self).__init__()
        ...
        # self.convxia123 = convxiajiang(64)
        # self.convxia1234 = convxiajiang(128)
        # self.convxia12345 = convxiajiang(256)
