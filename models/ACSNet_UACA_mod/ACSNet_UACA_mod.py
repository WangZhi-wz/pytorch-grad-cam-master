...
from models.ACSNet_UACA_mod.modules_UACA_mod import LCA, GCM, ASM, UACA, UACA_end, UACA_modify
...
class ACSNet_UACA_mod(nn.Module):
    def __init__(self, num_classes):
        super(ACSNet_UACA_mod, self).__init__()
