...
from models.ACSNet_caUACAsa_DCR.modules_caUACAsa_DCR import GCM, ASM, GCM_RFB, UACA_end, UACA_modify, UACA
from models.ACSNet_caUACAsa_DCR.modules import conv2d, conv1d, PAM_Module
...
class ACSNet_caUACAsa_DCR(nn.Module):
    def __init__(self,
                 bank_size=20,
                 num_classes=1,
                 num_channels=3,
        ...
        super(ACSNet_caUACAsa_DCR, self).__init__()
