...
from models.ACSNet_LLCApp.modules_LLCApp import LCA4, LCA_32, GCM, ASM, LCA_modify_end
...
class ACSNet_LLCApp(nn.Module):
    def __init__(self, num_classes):
        super(ACSNet_LLCApp, self).__init__()
        ...
        self.lca4 = LCA4(512)
        self.lca3 = LCA_32(256)
        self.lca2 = LCA_32(128)
    ...
    def forward(self, x):
        ...
        # GCM
        global_contexts = self.gcm(e5)  # 0:(1, 256, 16, 16) 1:(1, 128, 32, 32) 2:(1, 64, 64, 64) 3:(1, 64, 128, 128)


        # Decoder5
        d5 = self.decoder5(e5)          # conv1(512,128)->conv2(128,512)->upsample-> (1, 512, 16, 16)
        out5 = self.sideout5(d5)        # conv1(512,128)->drop(0.1)->conv2(128,1)-> (2, 1, 16, 16)
        lc4 = self.lca4(e4, out5, e5)       # e4:256 x 16 x 16 + out5:1 x 16 x 16 -> (2, 256, 16, 16)
        ...
        lc3 = self.lca3(e3, out4, lc4, e4)       # e3:(1, 128, 32, 32) + out5:(2, 1, 32, 32) -> (2, 128, 32, 32)
        ...
        lc2 = self.lca2(e2, out3, lc3, e3)       # e2:(1, 64, 64, 64) + out5:(2, 1, 64, 64) -> (2, 64, 64, 64)
        ...
        lc1 = self.lca1(e1, out2, lc2, e2)       # e1:(1, 64, 128, 128)  + out5:(2, 1, 128, 128) -> (2, 64, 128, 128)
