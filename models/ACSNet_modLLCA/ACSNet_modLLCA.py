...
from models.ACSNet_modLLCA.modules_modLLCA import GCM, ASM, CSAMBlock, LCA4, LCA32, LCA1
...
class ACSNet_modLLCA(nn.Module):
    def __init__(self, num_classes):
        super(ACSNet_modLLCA, self).__init__()
        ...
        self.lca4 = LCA4(256, 16)
        self.lca3 = LCA32(256, 128, 16)
        self.lca2 = LCA32(128, 64, 16)
        self.lca1 = LCA1(64, 16)
