...
from models.ACSNet_RFB_LLCA_CSAM_UACA.modules_RFB_LLCA_CSAM_UACA import UACA, UACA_end, UACA_modify, CSAMBlock, GCM_RFB, \
    ASM
...
class ACSNet_RFB_LLCA_CSAM_UACA(nn.Module):
    def __init__(self, num_classes):
        super(ACSNet_RFB_LLCA_CSAM_UACA, self).__init__()
        ...
        self.lca3 = UACA_modify(128, 128, 256)
        self.lca4 = UACA(256, 256)
