...
from models.ACSNet_caRABAsa_modDCR.modules_caRABAsa_modDCR import GCM, ASM, GCM_RFB, ASM_nogcm, CSAMBlock, \
    LCA11, LCA32, LCA44, RA1, RA4, NonLocalBlock, CSAMBlock1, CSAMBlock432, GCM_RFB_s, GCM_CBAM23, \
...
from models.ACSNet_caRABAsa_modDCR.modules import conv2d, conv1d, PAM_Module, CAM_Module
...
class ACSNet_caRABAsa_modDCR(nn.Module):
    def __init__(self,
                 bank_size=20,
                 num_classes=1,
                 num_channels=3,
        ...
        super(ACSNet_caRABAsa_modDCR, self).__init__()
