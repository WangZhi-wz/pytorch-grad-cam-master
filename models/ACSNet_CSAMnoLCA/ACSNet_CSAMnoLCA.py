...
from models.ACSNet_CSAMnoLCA.modules_CSAMnoLCA import LCA, GCM, ASM, CSAMBlock
...
class ACSNet_CSAMnoLCA(nn.Module):
    def __init__(self, num_classes):
        super(ACSNet_CSAMnoLCA, self).__init__()
        ...
        # self.lca3 = LCA()
        # self.lca4 = LCA()
        self.lca1 = CSAMBlock(channel=64, reduction=16)
        self.lca2 = CSAMBlock(channel=64, reduction=16)
        self.lca3 = CSAMBlock(channel=128, reduction=16)
        self.lca4 = CSAMBlock(channel=256, reduction=16)
