...
from models.ACSNet_LLCA_CSAM_UACA.modules_LLCA_CSAM_UACA import LCA, GCM, ASM, LCA_modify, LCA_modify_end, CSAMBlock, \
    UACA, UACA_modify, UACA_end
...
class ACSNet_LLCA_CSAM_UACA(nn.Module):
    def __init__(self, num_classes):
        super(ACSNet_LLCA_CSAM_UACA, self).__init__()
        ...
        # self.lca1 = UACA(64, 64)
        # self.lca2 = UACA(64, 64)
        # self.lca3 = UACA(128, 64)
        # self.lca4 = UACA(256, 64)
        self.lca1 = UACA_end(64, 64)
        self.lca2 = UACA_modify(64, 64, 128)
        self.lca3 = UACA_modify(128, 64, 256)
        self.lca4 = UACA(256, 64)
