...
from models.ACSNet_caRAsa_modSE.modules_caRAsa_modSE import GCM, ASM, LCA4, LCA1, LCA23, GCM_RFB
...
class ACSNet_caRAsa_modSE(nn.Module):
    # 将ASM的SE模块换成scSE模块，空间和通道间，都考虑注意力机制
    def __init__(self, num_classes):
        super(ACSNet_caRAsa_modSE, self).__init__()
