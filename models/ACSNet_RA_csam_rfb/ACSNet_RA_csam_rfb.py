...
from models.ACSNet_RA_csam_rfb.modules_RA_csan_rfb import GCM, ASM, LCA4, LCA1, LCA23, GCM_RFB
...
class ACSNet_RA_csam_rfb(nn.Module):
    def __init__(self, num_classes):
        super(ACSNet_RA_csam_rfb, self).__init__()
    ...
    def forward(self, x):
        ...
        # GCM
        global_contexts = self.gcm(e1, e2, e3, e4, e5)  # 0:(1, 256, 16, 16) 1:(1, 128, 32, 32) 2:(1, 64, 64, 64) 3:(1, 64, 128, 128)
