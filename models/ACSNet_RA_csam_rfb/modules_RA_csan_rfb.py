...
class GCM_RFB(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.dp = DropBlock(block_size=7, p=0.9)
        self.conv11 = nn.Conv2d(channel[0], channel[1], 1, 1)
        self.conv12 = nn.Conv2d(channel[1], channel[2], 1, 1)
        self.conv13 = nn.Conv2d(channel[2], channel[3], 1, 1)
