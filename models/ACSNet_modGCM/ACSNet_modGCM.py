...
from models.ACSNet_modGCM.modules_modGCM import LCA, GCM, ASM, GCM_RFB, CSAMBlock
...
class ACSNet_modGCM(nn.Module):
    def __init__(self, num_classes):
        super(ACSNet_modGCM, self).__init__()
        ...
        # GCM_up
        # self.gcm_e5 = GCM_up(512, 256)#3
        # self.gcm_e4 = GCM_up(512, 128)#2
        # self.gcm_e3 = GCM_up(512, 64)#1
        # self.gcm_e2 = GCM_up(512, 64)#0
