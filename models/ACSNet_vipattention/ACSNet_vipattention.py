...
from models.ACSNet_vipattention.ViP import WeightedPermuteMLP
from models.ACSNet_vipattention.modules_vipattention import LCA, GCM, ASM
...
class ACSNet_vipattention(nn.Module):
    def __init__(self, num_classes):
        super(ACSNet_vipattention, self).__init__()
        ...
        self.vip = WeightedPermuteMLP(512, 8)
