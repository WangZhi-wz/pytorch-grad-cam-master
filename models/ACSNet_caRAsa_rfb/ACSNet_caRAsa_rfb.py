...
from models.ACSNet_caRAsa_rfb.modules_caRAsa_rfb import GCM, ASM, LCA4, LCA1, LCA23, GCM_RFB
...
class ACSNet_caRAsa_rfb(nn.Module):
    # 将GCM模块的PPM换成RFB模块，同样是用于提取全局信息
    def __init__(self, num_classes):
        super(ACSNet_caRAsa_rfb, self).__init__()
