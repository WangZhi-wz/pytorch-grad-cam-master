...
from models.ACSNet_noGCM.modules_noGCM import LCA, GCM, ASM
from models.ACSNet_noGCM_LA.modules_noGCM_LA import text_classifier, embedding_feature_fusion
...
class ACSNet_noGCM_LA(nn.Module):
    def __init__(self, num_classes):
        super(ACSNet_noGCM_LA, self).__init__()

        # resnet = models.resnext50_32x4d(pretrained=True)    # resnext50_32x4d
        ...
        # self.gcm = GCM(512, 64)
        self.text_classifier = text_classifier(512, [2, 3])
        self.label_fc = embedding_feature_fusion([2, 3, 300], 128)


        # adaptive selection module
        self.asm4 = ASM(512, 1024, 256)
        self.asm3 = ASM(256, 512, 128)
        self.asm2 = ASM(128, 256, 64)
        self.asm1 = ASM(64, 192, 64)
    ...
    def forward(self, x, gt):
        ...
        num_polyps, polyp_sizes = self.text_classifier(e5)
        f0 = self.label_fc(num_polyps, polyp_sizes, gt)
